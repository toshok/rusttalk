...
pub fn lt(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs < rhs) }
pub fn gt(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs > rhs) }
pub fn le(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs <= rhs) }
pub fn ge(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs >= rhs) }
pub fn eq(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs == rhs) }
pub fn ne(interp: &mut Interpreter) -> PrimResult { si_logical_op(interp, |lhs, rhs| lhs != rhs) }
